export default function StatsCards() {
  return (
    <div className="w-full col-span-7 mx-auto bg-[#2B3340] text-white rounded-xl mt-4 p-6 grid grid-cols-1 md:grid-cols-2 gap-6 shadow-xl">
      {/* LEFT CARD — New Visitors */}
      <div className="bg-[#2B3340] shadow-xl border border-[#A9D18E] h-[max-content] rounded-xl p-4 flex flex-col justify-between gap-6">
        {/* Header */}
      ...
      {/* RIGHT CARD — Activity */}
      <div className="bg-[#2B3340] shadow-xl border border-[#A9D18E] rounded-xl p-4 flex flex-col justify-between">
        {/* Header */}
