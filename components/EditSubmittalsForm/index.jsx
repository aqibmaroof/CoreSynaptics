...
export default function SubmittalEditForm({
  ...
  const inputClass =
    "w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 transition-all";
    ...
    <div className="bg-gray-800 rounded-xl shadow-2xl border border-gray-700 overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full mt-5 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all"
        >
