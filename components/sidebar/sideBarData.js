...
export const ROLE_MODULES = {
  OEM: [
    ROLES.OEM_VP_OPS, ROLES.OEM_SALES_DIR, ROLES.OEM_VP_ENG,
    ROLES.OEM_NATL_PM, ROLES.OEM_REG_PM, ROLES.OEM_SR_PM, ROLES.OEM_PM, ROLES.OEM_APM, ROLES.OEM_COORD,
    ROLES.OEM_REG_FSM, ROLES.OEM_LEAD_FSE, ROLES.OEM_SR_FSE, ROLES.OEM_FSE, ROLES.OEM_APP_FSE, ROLES.OEM_SVC_DISPATCH,
    ROLES.OEM_CX_LEAD, ROLES.OEM_SR_CX, ROLES.OEM_CX,
    ROLES.OEM_APP_ENG, ROLES.OEM_SR_APP_ENG, ROLES.OEM_SOL_ENG,
    ROLES.OEM_SALES_REP, ROLES.OEM_INSIDE_SALES, ROLES.OEM_SALES_ENG, ROLES.OEM_ACCT_MGR,
    ROLES.OEM_SAFETY_MGR, ROLES.OEM_SAFETY_OFF, ROLES.OEM_QAQC_MGR, ROLES.OEM_QAQC_INSP,
    ROLES.OEM_SCHEDULER, ROLES.OEM_SITE_SCHEDULER, ROLES.OEM_PROJ_CTRL, ROLES.OEM_ESTIMATOR,
    ROLES.OEM_WARRANTY_MGR, ROLES.OEM_WARRANTY, ROLES.OEM_PARTS, ROLES.OEM_RMA,
    ROLES.OEM_FINANCE, ROLES.OEM_AR, ROLES.OEM_ADMIN,
  ],
  GC: [
    ROLES.GC_PROJ_EXEC, ROLES.GC_VP_OPS, ROLES.GC_VP_PRECON,
    ROLES.GC_SR_PM, ROLES.GC_PM, ROLES.GC_APM, ROLES.GC_PROJ_ENG, ROLES.GC_DOC_CTRL,
    ROLES.GC_SR_SUPER, ROLES.GC_SUPER, ROLES.GC_ASST_SUPER, ROLES.GC_GEN_FOREMAN, ROLES.GC_FOREMAN,
    ROLES.GC_VP_MEP, ROLES.GC_SR_MEP_PM, ROLES.GC_MEP_PM, ROLES.GC_SR_MEP_SUPER, ROLES.GC_MEP_SUPER,
    ROLES.GC_ASST_MEP_SUPER, ROLES.GC_MEP_ELEC_SUPER, ROLES.GC_MEP_MECH_SUPER,
    ROLES.GC_MEP_COORD, ROLES.GC_MEP_ENG, ROLES.GC_MEP_QAQC,
    ROLES.GC_BIM_MGR, ROLES.GC_VDC_COORD, ROLES.GC_BIM_MEP,
    ROLES.GC_SAFETY_MGR, ROLES.GC_SITE_SAFETY, ROLES.GC_QAQC,
    ROLES.GC_SCHEDULER, ROLES.GC_ESTIMATOR, ROLES.GC_BUYER,
  ],
  CUSTOMER: [
    ROLES.CUST_VP_INFRA, ROLES.CUST_DIR_DC, ROLES.CUST_DC_PROG_DIR,
    ROLES.CUST_PROG_DIR, ROLES.CUST_PROG_LEAD, ROLES.CUST_SR_CONST_PM, ROLES.CUST_CONST_COORD, ROLES.CUST_OWNER_REP,
    ROLES.CUST_DC_OPS, ROLES.CUST_FACILITY_MGR, ROLES.CUST_CAMPUS_FAC_MGR, ROLES.CUST_CRIT_OPS_MGR,
    ROLES.CUST_CHIEF_ENG, ROLES.CUST_LEAD_BLDG_ENG, ROLES.CUST_CRIT_FAC_ENG, ROLES.CUST_BLDG_ENG,
    ROLES.CUST_ELEC_TECH, ROLES.CUST_CTRL_TECH,
    ROLES.CUST_NET_OPS, ROLES.CUST_SEC_OPS, ROLES.CUST_EHS_MGR,
    ROLES.CUST_PROCURE, ROLES.CUST_LEGAL, ROLES.CUST_FINANCE, ROLES.CUST_HR, ROLES.CUST_PAYROLL,
    ROLES.CUST_JANITORIAL, ROLES.CUST_GROUNDS,
  ],
  TRADE: [
    ROLES.TR_PM, ROLES.TR_APM, ROLES.TR_ENG, ROLES.TR_ESTIMATOR,
    ROLES.TR_ELEC_SUPER, ROLES.TR_ELEC_GEN_FOREMAN, ROLES.TR_ELEC_FOREMAN, ROLES.TR_JOURNEY, ROLES.TR_APP,
    ROLES.TR_MECH_ESTIMATOR, ROLES.TR_MECH_SUPER, ROLES.TR_MECH_GEN_FOREMAN, ROLES.TR_MECH_FOREMAN,
    ROLES.TR_PIPEFITTER, ROLES.TR_SHEET_METAL, ROLES.TR_MECH_APP, ROLES.TR_MECH_SAFETY,
    ROLES.TR_FP_DESIGNER, ROLES.TR_FP_FOREMAN, ROLES.TR_SPRINKLER,
    ROLES.TR_SEC_DESIGNER, ROLES.TR_SEC_FOREMAN, ROLES.TR_SEC_ACS_TECH,
    ROLES.TR_CABLING_FOREMAN, ROLES.TR_FIBER_TECH,
    ROLES.TR_CTRL_PM, ROLES.TR_CTRL_ENG, ROLES.TR_CTRL_SUPER, ROLES.TR_CTRL_FOREMAN, ROLES.TR_CTRL_TECH, ROLES.TR_CTRL_PROG,
    ROLES.TR_QAQC, ROLES.TR_SAFETY,
  ],
  CXA: [
    ROLES.CXA_PRINCIPAL, ROLES.CXA_DIRECTOR, ROLES.CXA_LEAD, ROLES.CXA_AGENT,
    ROLES.CXA_SPEC, ROLES.CXA_FTL, ROLES.CXA_ENGINEER, ROLES.CXA_SR_ENGINEER_EE, ROLES.CXA_SR_ENGINEER_ME,
    ROLES.CXA_WRITER, ROLES.CXA_COORD, ROLES.CXA_DOC,
  ],
  AE: [
    ROLES.AE_PRINCIPAL, ROLES.AE_PM,
    ROLES.AE_ARCH, ROLES.AE_ARCH_DESIGN, ROLES.AE_ARCH_PROJECT,
    ROLES.AE_LEAD_ENG, ROLES.AE_MEP_LEAD, ROLES.AE_ELEC_ENG, ROLES.AE_MECH_ENG,
    ROLES.AE_PLUMB_ENG, ROLES.AE_FIRE_ENG, ROLES.AE_CTRL_ENG,
    ROLES.AE_STRUCT, ROLES.AE_CIVIL, ROLES.AE_DRAFTER,
    ROLES.AE_CA_LEAD, ROLES.AE_RFI_COORD, ROLES.AE_FIELD_ENG,
  ],
  RIGGING: [
    ROLES.RIG_PM, ROLES.RIG_LIFT_DIR, ROLES.RIG_ENG, ROLES.RIG_SUPER, ROLES.RIG_FOREMAN,
    ROLES.RIG_CRANE_OP, ROLES.RIG_CRANE_OP_JR, ROLES.RIG_SIGNAL,
    ROLES.RIG_RIGGER_LEAD, ROLES.RIG_RIGGER, ROLES.RIG_OILER, ROLES.RIG_TRUCK_DRIVER, ROLES.RIG_DISPATCH,
    ROLES.RIG_SAFETY_MGR, ROLES.RIG_SAFETY_OFF, ROLES.RIG_INSPECTOR,
  ],
  BUILDER: [
    ROLES.BLD_PROJ_EXEC, ROLES.BLD_VP_OPS, ROLES.BLD_SR_PM, ROLES.BLD_PM, ROLES.BLD_APM, ROLES.BLD_ENG,
    ROLES.BLD_SUPER, ROLES.BLD_ASST_SUPER, ROLES.BLD_GEN_FOREMAN,
    ROLES.BLD_CONCRETE_FOREMAN, ROLES.BLD_STEEL_FOREMAN,
    ROLES.BLD_CARPENTER, ROLES.BLD_IRONWORKER, ROLES.BLD_FINISHER, ROLES.BLD_LABORER,
    ROLES.BLD_SAFETY_MGR, ROLES.BLD_QAQC, ROLES.BLD_SCHEDULER, ROLES.BLD_ESTIMATOR,
  ],
  SECURITY: [
    ROLES.SEC_PM, ROLES.SEC_ENG_MGR, ROLES.SEC_DESIGN, ROLES.SEC_SYS_ENG, ROLES.SEC_PROG, ROLES.SEC_CCTV_ENG,
    ROLES.SEC_LEAD_TECH, ROLES.SEC_TECH, ROLES.SEC_INSTALL, ROLES.SEC_APP,
    ROLES.SEC_CONSOLE_MGR, ROLES.SEC_CONSOLE_OP, ROLES.SEC_GUARD_SUPER,
    ROLES.SEC_QAQC, ROLES.SEC_SAFETY,
  ],
  FIRE: [
    ROLES.FA_PM, ROLES.FA_ENG_MGR, ROLES.FA_DESIGN_ENG, ROLES.FA_DESIGNER, ROLES.FA_SUPP_ENG,
    ROLES.FA_SUPER, ROLES.FA_LEAD_TECH, ROLES.FA_TECH, ROLES.FA_INSTALL, ROLES.FA_PIPE_FITTER,
    ROLES.FA_TEST_LEAD, ROLES.FA_INSPECTOR, ROLES.FA_QAQC, ROLES.FA_SAFETY,
  ],
  STAFFING: [
    ROLES.ST_OWNER, ROLES.ST_ACCT_MGR, ROLES.ST_BIZ_DEV, ROLES.ST_RECR_MGR,
    ROLES.ST_RECRUITER, ROLES.ST_SOURCER, ROLES.ST_OPS_MGR,
    ROLES.ST_PAYROLL, ROLES.ST_COMPLIANCE, ROLES.ST_FIELD_REP,
  ],
  INTEGRATOR: [
    ROLES.INT_PRINCIPAL, ROLES.INT_VP_ENG, ROLES.INT_SR_PM, ROLES.INT_PM, ROLES.INT_APM, ROLES.INT_COORD,
    ROLES.INT_ENG_MGR, ROLES.INT_SR_CTRL_ENG, ROLES.INT_CTRL_ENG, ROLES.INT_PROG,
    ROLES.INT_SCADA_ENG, ROLES.INT_GRAPHICS, ROLES.INT_NET_ENG,
    ROLES.INT_SHOP_MGR, ROLES.INT_PANEL_LEAD, ROLES.INT_PANEL_TECH, ROLES.INT_WIREMAN, ROLES.INT_QC_FACTORY,
    ROLES.INT_LEAD_FIELD, ROLES.INT_FIELD_TECH, ROLES.INT_STARTUP_ENG, ROLES.INT_CX_ENG,
    ROLES.INT_SALES, ROLES.INT_ESTIMATOR, ROLES.INT_SAFETY_MGR, ROLES.INT_QAQC_MGR,
    ROLES.INT_WARRANTY, ROLES.INT_REMOTE_OPS,
  ],
  CONTROLS: [
    ROLES.CT_PM, ROLES.CT_APM, ROLES.CT_ENG_MGR, ROLES.CT_SR_CTRL_ENG, ROLES.CT_CTRL_ENG,
    ROLES.CT_BMS_PROG, ROLES.CT_PLC_PROG, ROLES.CT_GRAPHICS, ROLES.CT_NET_ENG,
    ROLES.CT_SUPER, ROLES.CT_FOREMAN, ROLES.CT_LEAD_TECH, ROLES.CT_TECH, ROLES.CT_APP,
    ROLES.CT_STARTUP_ENG, ROLES.CT_CX_ENG, ROLES.CT_QAQC, ROLES.CT_SAFETY,
  ],
  LOW_VOLTAGE: [
    ROLES.LV_PM, ROLES.LV_APM, ROLES.LV_ESTIMATOR, ROLES.LV_DESIGNER, ROLES.LV_ENG,
    ROLES.LV_SUPER, ROLES.LV_FOREMAN, ROLES.LV_LEAD_TECH,
    ROLES.LV_FIBER_TECH, ROLES.LV_COPPER_TECH, ROLES.LV_TESTER, ROLES.LV_APP,
    ROLES.LV_QAQC, ROLES.LV_SAFETY,
  ],
  MECHANICAL: [
    ROLES.MC_PM, ROLES.MC_APM, ROLES.MC_ENG, ROLES.MC_ESTIMATOR,
    ROLES.MC_SUPER, ROLES.MC_GEN_FOREMAN, ROLES.MC_FOREMAN,
    ROLES.MC_PIPEFITTER, ROLES.MC_JOURNEY_PF, ROLES.MC_SHEET_METAL, ROLES.MC_JOURNEY_SM,
    ROLES.MC_HVAC_TECH, ROLES.MC_WELDER, ROLES.MC_APP,
    ROLES.MC_QAQC, ROLES.MC_SAFETY,
  ],
  OPERATIONS: [
    ROLES.OPS_OEM_DIR_PROJ, ROLES.OPS_OEM_DIR_FS, ROLES.OPS_OEM_VP_OPS, ROLES.OPS_OEM_VP_ENG,
    ROLES.OPS_GC_VP_OPS, ROLES.OPS_GC_VP_PRECON, ROLES.OPS_CXA_DIR_CX,
    ROLES.OPS_SALES_DIR, ROLES.OPS_SR_ACCT_SALES_MGR, ROLES.OPS_SALES_MGR,
    ROLES.OPS_ACCT_MGR, ROLES.OPS_SALES_REP, ROLES.OPS_SALES_ENG, ROLES.OPS_SOL_ENG, ROLES.OPS_ESTIMATOR,
    ROLES.OPS_FINANCE_MGR, ROLES.OPS_PROJ_CTRL_ANALYST, ROLES.OPS_PAYROLL_SPEC,
    ROLES.OPS_HR_MGR, ROLES.OPS_RECRUITER, ROLES.OPS_TRAINING_COORD,
    ROLES.OPS_CONTRACTS_ADMIN, ROLES.OPS_PROCURE_MGR,
  ],
  CUSTOMER_CONSTRUCTION: [
    ROLES.CC_VP_CONST, ROLES.CC_DIR_CONST, ROLES.CC_DC_PROG_DIR, ROLES.CC_PROG_DIR,
    ROLES.CC_SR_CONST_PM, ROLES.CC_CONST_PM, ROLES.CC_CONST_COORD, ROLES.CC_OWNER_REP,
    ROLES.CC_MEP_PM, ROLES.CC_MEP_ENG, ROLES.CC_CONST_QAQC,
    ROLES.CC_EHS, ROLES.CC_PROCURE, ROLES.CC_CONTRACTS, ROLES.CC_FINANCE,
  ],
  PLATFORM: [
    ROLES.SUPERADMIN, ROLES.PLATFORM_ADMIN,
  ],
};
...
export const ROLE_LABELS = {
  ...
  [ROLES.OEM_CX_LEAD]: "Cx Lead",
  [ROLES.OEM_SR_CX]: "Senior Cx Engineer",
  [ROLES.OEM_CX]: "Cx Engineer",
  ...
  [ROLES.CXA_LEAD]: "Cx Lead",
  [ROLES.CXA_AGENT]: "Cx Agent",
  [ROLES.CXA_SPEC]: "Cx Specialist",
  [ROLES.CXA_FTL]: "Functional Test Lead",
  [ROLES.CXA_ENGINEER]: "Cx Engineer",
  [ROLES.CXA_SR_ENGINEER_EE]: "Senior Cx Engineer (EE)",
  [ROLES.CXA_SR_ENGINEER_ME]: "Senior Cx Engineer (ME)",
  [ROLES.CXA_WRITER]: "Cx Writer",
  [ROLES.CXA_COORD]: "Cx Coordinator",
  [ROLES.CXA_DOC]: "Cx Documentation Specialist",
  // AE
...
export const ROLE_TIERS = {
  executive: [
    ROLES.OEM_VP_OPS, ROLES.OEM_SALES_DIR, ROLES.OEM_VP_ENG, ROLES.OEM_FINANCE,
    ROLES.GC_PROJ_EXEC, ROLES.GC_VP_OPS, ROLES.GC_VP_PRECON, ROLES.GC_VP_MEP,
    ROLES.CUST_VP_INFRA, ROLES.CUST_DIR_DC, ROLES.CUST_DC_PROG_DIR, ROLES.CUST_PROG_DIR,
    ROLES.CXA_PRINCIPAL, ROLES.CXA_DIRECTOR,
    ROLES.AE_PRINCIPAL,
    ROLES.RIG_LIFT_DIR,
    ROLES.BLD_PROJ_EXEC, ROLES.BLD_VP_OPS,
    ROLES.INT_PRINCIPAL, ROLES.INT_VP_ENG,
    ROLES.ST_OWNER,
    ROLES.OPS_OEM_DIR_PROJ, ROLES.OPS_OEM_DIR_FS, ROLES.OPS_OEM_VP_OPS, ROLES.OPS_OEM_VP_ENG,
    ROLES.OPS_GC_VP_OPS, ROLES.OPS_GC_VP_PRECON, ROLES.OPS_CXA_DIR_CX, ROLES.OPS_SALES_DIR,
    ROLES.CC_VP_CONST, ROLES.CC_DIR_CONST, ROLES.CC_DC_PROG_DIR, ROLES.CC_PROG_DIR,
    ROLES.SUPERADMIN, ROLES.PLATFORM_ADMIN, ROLES.EXECUTIVE,
  ],
  director: [
    ROLES.OEM_SALES_DIR, ROLES.OEM_REG_FSM,
    ROLES.GC_VP_MEP,
    ROLES.CUST_DIR_DC, ROLES.CUST_DC_PROG_DIR,
    ROLES.RIG_LIFT_DIR,
    ROLES.OPS_OEM_DIR_PROJ, ROLES.OPS_OEM_DIR_FS, ROLES.OPS_CXA_DIR_CX, ROLES.OPS_SALES_DIR,
  ],
  manager: [
    ROLES.OEM_NATL_PM, ROLES.OEM_REG_PM, ROLES.OEM_SR_PM, ROLES.OEM_PM,
    ROLES.OEM_WARRANTY_MGR, ROLES.OEM_SAFETY_MGR, ROLES.OEM_QAQC_MGR,
    ROLES.GC_SR_PM, ROLES.GC_PM, ROLES.GC_SR_MEP_PM, ROLES.GC_MEP_PM, ROLES.GC_BIM_MGR, ROLES.GC_SAFETY_MGR, ROLES.GC_QAQC,
    ROLES.CUST_PROG_LEAD, ROLES.CUST_SR_CONST_PM, ROLES.CUST_DC_OPS,
    ROLES.CUST_FACILITY_MGR, ROLES.CUST_CAMPUS_FAC_MGR, ROLES.CUST_CRIT_OPS_MGR, ROLES.CUST_EHS_MGR,
    ROLES.TR_PM, ROLES.SEC_PM, ROLES.SEC_ENG_MGR, ROLES.SEC_CONSOLE_MGR,
    ROLES.FA_PM, ROLES.FA_ENG_MGR,
    ROLES.ST_ACCT_MGR, ROLES.ST_RECR_MGR, ROLES.ST_OPS_MGR,
    ROLES.INT_SR_PM, ROLES.INT_PM, ROLES.INT_ENG_MGR, ROLES.INT_SHOP_MGR, ROLES.INT_SAFETY_MGR, ROLES.INT_QAQC_MGR,
    ROLES.CT_PM, ROLES.CT_ENG_MGR,
    ROLES.RIG_PM, ROLES.RIG_SAFETY_MGR,
    ROLES.BLD_SR_PM, ROLES.BLD_PM, ROLES.BLD_SAFETY_MGR,
    ROLES.LV_PM, ROLES.MC_PM,
    ROLES.AE_PM, ROLES.CXA_LEAD,
    ROLES.OPS_SALES_MGR, ROLES.OPS_SR_ACCT_SALES_MGR, ROLES.OPS_FINANCE_MGR, ROLES.OPS_HR_MGR, ROLES.OPS_PROCURE_MGR,
    ROLES.CC_SR_CONST_PM, ROLES.CC_CONST_PM,
  ],
  lead: [
    ROLES.OEM_LEAD_FSE, ROLES.OEM_CX_LEAD, ROLES.OEM_SR_CX, ROLES.OEM_SR_APP_ENG,
    ROLES.GC_SR_SUPER, ROLES.GC_SR_MEP_SUPER,
    ROLES.CXA_LEAD, ROLES.AE_LEAD_ENG, ROLES.AE_MEP_LEAD, ROLES.AE_CA_LEAD,
    ROLES.RIG_RIGGER_LEAD,
    ROLES.SEC_LEAD_TECH, ROLES.FA_LEAD_TECH, ROLES.FA_TEST_LEAD,
    ROLES.INT_PANEL_LEAD, ROLES.INT_LEAD_FIELD,
    ROLES.CT_LEAD_TECH, ROLES.LV_LEAD_TECH,
  ],
  engineer: [
    ROLES.OEM_APP_ENG, ROLES.OEM_SR_APP_ENG, ROLES.OEM_SOL_ENG, ROLES.OEM_SR_FSE, ROLES.OEM_FSE,
    ROLES.GC_PROJ_ENG, ROLES.GC_MEP_ENG,
    ROLES.CUST_CHIEF_ENG, ROLES.CUST_LEAD_BLDG_ENG, ROLES.CUST_CRIT_FAC_ENG, ROLES.CUST_BLDG_ENG,
    ROLES.TR_ENG, ROLES.TR_CTRL_ENG,
    ROLES.CXA_ENGINEER, ROLES.CXA_SR_ENGINEER_EE, ROLES.CXA_SR_ENGINEER_ME,
    ROLES.AE_ELEC_ENG, ROLES.AE_MECH_ENG, ROLES.AE_PLUMB_ENG, ROLES.AE_FIRE_ENG, ROLES.AE_CTRL_ENG, ROLES.AE_STRUCT, ROLES.AE_CIVIL,
    ROLES.RIG_ENG,
    ROLES.BLD_ENG,
    ROLES.SEC_SYS_ENG, ROLES.SEC_CCTV_ENG,
    ROLES.FA_DESIGN_ENG, ROLES.FA_SUPP_ENG,
    ROLES.INT_SR_CTRL_ENG, ROLES.INT_CTRL_ENG, ROLES.INT_SCADA_ENG, ROLES.INT_NET_ENG, ROLES.INT_STARTUP_ENG, ROLES.INT_CX_ENG,
    ROLES.CT_SR_CTRL_ENG, ROLES.CT_CTRL_ENG, ROLES.CT_NET_ENG, ROLES.CT_STARTUP_ENG, ROLES.CT_CX_ENG,
    ROLES.LV_ENG, ROLES.MC_ENG,
    ROLES.OPS_SALES_ENG, ROLES.OPS_SOL_ENG,
    ROLES.CC_MEP_ENG,
  ],
  coordinator: [
    ROLES.OEM_APM, ROLES.OEM_COORD, ROLES.OEM_PARTS, ROLES.OEM_SITE_SCHEDULER,
    ROLES.GC_APM, ROLES.GC_DOC_CTRL, ROLES.GC_MEP_COORD, ROLES.GC_VDC_COORD,
    ROLES.CUST_CONST_COORD, ROLES.CUST_OWNER_REP,
    ROLES.TR_APM, ROLES.CXA_COORD, ROLES.AE_RFI_COORD,
    ROLES.INT_APM, ROLES.INT_COORD, ROLES.CT_APM, ROLES.LV_APM, ROLES.MC_APM,
    ROLES.CC_CONST_COORD, ROLES.CC_OWNER_REP,
    ROLES.OPS_TRAINING_COORD, ROLES.OPS_CONTRACTS_ADMIN, ROLES.OPS_PROJ_CTRL_ANALYST,
  ],
  technician: [
    ROLES.OEM_APP_FSE, ROLES.OEM_SVC_DISPATCH,
    ROLES.CUST_ELEC_TECH, ROLES.CUST_CTRL_TECH,
    ROLES.TR_CTRL_TECH, ROLES.TR_SEC_ACS_TECH, ROLES.TR_FIBER_TECH,
    ROLES.SEC_TECH, ROLES.SEC_INSTALL,
    ROLES.FA_TECH, ROLES.FA_INSTALL, ROLES.FA_PIPE_FITTER,
    ROLES.INT_PANEL_TECH, ROLES.INT_FIELD_TECH,
    ROLES.CT_TECH, ROLES.CT_APP,
    ROLES.LV_LEAD_TECH, ROLES.LV_FIBER_TECH, ROLES.LV_COPPER_TECH, ROLES.LV_TESTER, ROLES.LV_APP,
    ROLES.MC_HVAC_TECH, ROLES.MC_APP,
    ROLES.RIG_CRANE_OP, ROLES.RIG_CRANE_OP_JR, ROLES.RIG_OILER,
  ],
  admin: [
    ROLES.OEM_ADMIN, ROLES.OEM_AR,
    ROLES.GC_DOC_CTRL, ROLES.GC_BUYER,
    ROLES.CUST_HR, ROLES.CUST_PAYROLL, ROLES.CUST_LEGAL,
    ROLES.ST_COMPLIANCE, ROLES.ST_PAYROLL,
    ROLES.OPS_CONTRACTS_ADMIN, ROLES.OPS_PAYROLL_SPEC,
    ROLES.CC_CONTRACTS,
    ROLES.SUPERADMIN, ROLES.PLATFORM_ADMIN,
  ],
  field: [
    ROLES.OEM_LEAD_FSE, ROLES.OEM_SR_FSE, ROLES.OEM_FSE, ROLES.OEM_APP_FSE,
    ROLES.GC_SR_SUPER, ROLES.GC_SUPER, ROLES.GC_ASST_SUPER, ROLES.GC_GEN_FOREMAN, ROLES.GC_FOREMAN,
    ROLES.GC_SR_MEP_SUPER, ROLES.GC_MEP_SUPER, ROLES.GC_ASST_MEP_SUPER, ROLES.GC_MEP_ELEC_SUPER, ROLES.GC_MEP_MECH_SUPER,
    ROLES.CUST_DC_OPS, ROLES.CUST_FACILITY_MGR, ROLES.CUST_JANITORIAL, ROLES.CUST_GROUNDS,
    ROLES.TR_ELEC_SUPER, ROLES.TR_ELEC_GEN_FOREMAN, ROLES.TR_ELEC_FOREMAN, ROLES.TR_JOURNEY, ROLES.TR_APP,
    ROLES.TR_MECH_SUPER, ROLES.TR_MECH_GEN_FOREMAN, ROLES.TR_MECH_FOREMAN, ROLES.TR_PIPEFITTER,
    ROLES.TR_SHEET_METAL, ROLES.TR_MECH_APP, ROLES.TR_FP_FOREMAN, ROLES.TR_SPRINKLER,
    ROLES.TR_SEC_FOREMAN, ROLES.TR_CABLING_FOREMAN, ROLES.TR_CTRL_SUPER, ROLES.TR_CTRL_FOREMAN,
    ROLES.RIG_SUPER, ROLES.RIG_FOREMAN, ROLES.RIG_SIGNAL, ROLES.RIG_RIGGER, ROLES.RIG_TRUCK_DRIVER, ROLES.RIG_DISPATCH,
    ROLES.BLD_SUPER, ROLES.BLD_ASST_SUPER, ROLES.BLD_GEN_FOREMAN, ROLES.BLD_CONCRETE_FOREMAN, ROLES.BLD_STEEL_FOREMAN,
    ROLES.BLD_CARPENTER, ROLES.BLD_IRONWORKER, ROLES.BLD_FINISHER, ROLES.BLD_LABORER,
    ROLES.SEC_GUARD_SUPER, ROLES.SEC_CONSOLE_OP,
    ROLES.FA_SUPER, ROLES.CT_SUPER, ROLES.CT_FOREMAN, ROLES.LV_SUPER, ROLES.LV_FOREMAN,
    ROLES.MC_SUPER, ROLES.MC_GEN_FOREMAN, ROLES.MC_FOREMAN, ROLES.MC_PIPEFITTER,
    ROLES.MC_JOURNEY_PF, ROLES.MC_SHEET_METAL, ROLES.MC_JOURNEY_SM, ROLES.MC_WELDER,
    ROLES.INT_WIREMAN, ROLES.INT_LEAD_FIELD, ROLES.INT_FIELD_TECH, ROLES.ST_FIELD_REP,
    ROLES.AE_FIELD_ENG, ROLES.AE_DRAFTER, ROLES.INT_REMOTE_OPS,
  ],
  finance: [
    ROLES.OEM_FINANCE, ROLES.OEM_AR, ROLES.CUST_FINANCE, ROLES.CUST_PAYROLL,
    ROLES.ST_PAYROLL, ROLES.OPS_FINANCE_MGR, ROLES.OPS_PAYROLL_SPEC, ROLES.CC_FINANCE,
    ROLES.FINANCE,
  ],
  safety: [
    ROLES.OEM_SAFETY_MGR, ROLES.OEM_SAFETY_OFF,
    ROLES.GC_SAFETY_MGR, ROLES.GC_SITE_SAFETY,
    ROLES.CUST_EHS_MGR, ROLES.CUST_SEC_OPS,
    ROLES.TR_MECH_SAFETY, ROLES.TR_SAFETY,
    ROLES.RIG_SAFETY_MGR, ROLES.RIG_SAFETY_OFF,
    ROLES.BLD_SAFETY_MGR,
    ROLES.SEC_SAFETY, ROLES.FA_SAFETY, ROLES.INT_SAFETY_MGR,
    ROLES.CT_SAFETY, ROLES.LV_SAFETY, ROLES.MC_SAFETY, ROLES.CC_EHS,
    ROLES.SAFETY,
  ],
  qaqc: [
    ROLES.OEM_QAQC_MGR, ROLES.OEM_QAQC_INSP,
    ROLES.GC_MEP_QAQC, ROLES.GC_QAQC,
    ROLES.TR_QAQC,
    ROLES.BLD_QAQC,
    ROLES.SEC_QAQC, ROLES.FA_QAQC, ROLES.FA_INSPECTOR,
    ROLES.INT_QAQC_MGR, ROLES.INT_QC_FACTORY,
    ROLES.CT_QAQC, ROLES.LV_QAQC, ROLES.MC_QAQC,
    ROLES.RIG_INSPECTOR,
    ROLES.CC_CONST_QAQC,
    ROLES.QA_QC,
  ],
  operations: [
    ROLES.OPS_OEM_DIR_PROJ, ROLES.OPS_OEM_DIR_FS, ROLES.OPS_OEM_VP_OPS, ROLES.OPS_OEM_VP_ENG,
    ROLES.OPS_GC_VP_OPS, ROLES.OPS_GC_VP_PRECON, ROLES.OPS_CXA_DIR_CX,
    ROLES.INT_REMOTE_OPS, ROLES.CUST_NET_OPS,
  ],
};
...
export const ROLE_CANONICAL_GROUPS = {
  PROJECT_MANAGEMENT: [
    ROLES.OEM_NATL_PM, ROLES.OEM_REG_PM, ROLES.OEM_SR_PM, ROLES.OEM_PM, ROLES.OEM_APM, ROLES.OEM_COORD,
    ROLES.OEM_PROJ_CTRL, ROLES.OEM_SCHEDULER, ROLES.OEM_SITE_SCHEDULER,
    ROLES.GC_SR_PM, ROLES.GC_PM, ROLES.GC_APM, ROLES.GC_PROJ_ENG, ROLES.GC_DOC_CTRL,
    ROLES.GC_SR_MEP_PM, ROLES.GC_MEP_PM, ROLES.GC_MEP_COORD,
    ROLES.GC_BIM_MGR, ROLES.GC_VDC_COORD, ROLES.GC_BIM_MEP,
    ROLES.GC_SCHEDULER, ROLES.CUST_PROG_LEAD, ROLES.CUST_SR_CONST_PM, ROLES.CUST_CONST_COORD,
    ROLES.TR_PM, ROLES.TR_APM, ROLES.TR_ENG, ROLES.TR_CTRL_PM,
    ROLES.CXA_COORD, ROLES.AE_PM, ROLES.AE_RFI_COORD,
    ROLES.RIG_PM, ROLES.BLD_SR_PM, ROLES.BLD_PM, ROLES.BLD_APM, ROLES.BLD_ENG, ROLES.BLD_SCHEDULER,
    ROLES.SEC_PM, ROLES.FA_PM, ROLES.INT_SR_PM, ROLES.INT_PM, ROLES.INT_APM, ROLES.INT_COORD,
    ROLES.CT_PM, ROLES.CT_APM, ROLES.LV_PM, ROLES.LV_APM, ROLES.MC_PM, ROLES.MC_APM,
    ROLES.OPS_PROJ_CTRL_ANALYST,
    ROLES.CC_SR_CONST_PM, ROLES.CC_CONST_PM, ROLES.CC_CONST_COORD, ROLES.CC_MEP_PM,
  ],
  FIELD_SERVICE: [
    ROLES.OEM_REG_FSM, ROLES.OEM_LEAD_FSE, ROLES.OEM_SR_FSE, ROLES.OEM_FSE, ROLES.OEM_APP_FSE, ROLES.OEM_SVC_DISPATCH,
    ROLES.GC_SR_SUPER, ROLES.GC_SUPER, ROLES.GC_ASST_SUPER, ROLES.GC_GEN_FOREMAN, ROLES.GC_FOREMAN,
    ROLES.GC_SR_MEP_SUPER, ROLES.GC_MEP_SUPER, ROLES.GC_ASST_MEP_SUPER, ROLES.GC_MEP_ELEC_SUPER, ROLES.GC_MEP_MECH_SUPER,
    ROLES.TR_ELEC_SUPER, ROLES.TR_ELEC_GEN_FOREMAN, ROLES.TR_ELEC_FOREMAN, ROLES.TR_JOURNEY, ROLES.TR_APP,
    ROLES.TR_MECH_SUPER, ROLES.TR_MECH_GEN_FOREMAN, ROLES.TR_MECH_FOREMAN,
    ROLES.TR_FP_FOREMAN, ROLES.TR_SEC_FOREMAN, ROLES.TR_CABLING_FOREMAN, ROLES.TR_CTRL_SUPER, ROLES.TR_CTRL_FOREMAN,
    ROLES.RIG_SUPER, ROLES.RIG_FOREMAN, ROLES.RIG_RIGGER_LEAD, ROLES.RIG_RIGGER, ROLES.RIG_CRANE_OP, ROLES.RIG_CRANE_OP_JR,
    ROLES.RIG_SIGNAL, ROLES.RIG_OILER, ROLES.RIG_TRUCK_DRIVER, ROLES.RIG_DISPATCH,
    ROLES.BLD_SUPER, ROLES.BLD_ASST_SUPER, ROLES.BLD_GEN_FOREMAN, ROLES.BLD_CONCRETE_FOREMAN, ROLES.BLD_STEEL_FOREMAN,
    ROLES.BLD_CARPENTER, ROLES.BLD_IRONWORKER, ROLES.BLD_FINISHER, ROLES.BLD_LABORER,
    ROLES.FA_SUPER, ROLES.FA_LEAD_TECH, ROLES.FA_TECH, ROLES.FA_INSTALL, ROLES.FA_PIPE_FITTER,
    ROLES.CT_SUPER, ROLES.CT_FOREMAN, ROLES.CT_LEAD_TECH, ROLES.CT_TECH,
    ROLES.LV_SUPER, ROLES.LV_FOREMAN, ROLES.LV_LEAD_TECH, ROLES.LV_FIBER_TECH, ROLES.LV_COPPER_TECH,
    ROLES.MC_SUPER, ROLES.MC_GEN_FOREMAN, ROLES.MC_FOREMAN, ROLES.MC_PIPEFITTER,
    ROLES.MC_JOURNEY_PF, ROLES.MC_SHEET_METAL, ROLES.MC_JOURNEY_SM, ROLES.MC_HVAC_TECH, ROLES.MC_WELDER,
    ROLES.INT_LEAD_FIELD, ROLES.INT_FIELD_TECH, ROLES.INT_REMOTE_OPS,
    ROLES.ST_FIELD_REP, ROLES.AE_FIELD_ENG,
  ],
  ENGINEERING: [
    ROLES.OEM_APP_ENG, ROLES.OEM_SR_APP_ENG, ROLES.OEM_SOL_ENG,
    ROLES.GC_PROJ_ENG, ROLES.GC_MEP_ENG,
    ...
    ROLES.CXA_ENGINEER, ROLES.CXA_SR_ENGINEER_EE, ROLES.CXA_SR_ENGINEER_ME,
    ROLES.AE_LEAD_ENG, ROLES.AE_MEP_LEAD, ROLES.AE_ELEC_ENG, ROLES.AE_MECH_ENG,
    ROLES.AE_PLUMB_ENG, ROLES.AE_FIRE_ENG, ROLES.AE_CTRL_ENG, ROLES.AE_STRUCT, ROLES.AE_CIVIL,
    ROLES.RIG_ENG, ROLES.BLD_ENG,
    ROLES.SEC_SYS_ENG, ROLES.SEC_CCTV_ENG, ROLES.SEC_DESIGN, ROLES.SEC_PROG,
    ROLES.FA_DESIGN_ENG, ROLES.FA_SUPP_ENG, ROLES.FA_DESIGNER,
    ROLES.INT_SR_CTRL_ENG, ROLES.INT_CTRL_ENG, ROLES.INT_SCADA_ENG, ROLES.INT_NET_ENG, ROLES.INT_GRAPHICS,
    ROLES.CT_SR_CTRL_ENG, ROLES.CT_CTRL_ENG, ROLES.CT_BMS_PROG, ROLES.CT_PLC_PROG, ROLES.CT_GRAPHICS, ROLES.CT_NET_ENG,
    ROLES.LV_ENG, ROLES.LV_DESIGNER, ROLES.MC_ENG,
    ROLES.OPS_SALES_ENG, ROLES.OPS_SOL_ENG, ROLES.CC_MEP_ENG,
  ],
  SALES: [
    ROLES.OEM_SALES_DIR, ROLES.OEM_SALES_REP, ROLES.OEM_INSIDE_SALES, ROLES.OEM_SALES_ENG, ROLES.OEM_ACCT_MGR, ROLES.OEM_ESTIMATOR,
    ROLES.GC_ESTIMATOR, ROLES.GC_BUYER,
    ROLES.CUST_PROCURE, ROLES.TR_ESTIMATOR, ROLES.TR_MECH_ESTIMATOR,
    ROLES.BLD_ESTIMATOR, ROLES.LV_ESTIMATOR, ROLES.MC_ESTIMATOR,
    ROLES.INT_SALES, ROLES.INT_ESTIMATOR, ROLES.ST_ACCT_MGR, ROLES.ST_BIZ_DEV,
    ROLES.OPS_SALES_DIR, ROLES.OPS_SR_ACCT_SALES_MGR, ROLES.OPS_SALES_MGR, ROLES.OPS_ACCT_MGR,
    ROLES.OPS_SALES_REP, ROLES.OPS_SALES_ENG, ROLES.OPS_SOL_ENG, ROLES.OPS_ESTIMATOR,
  ],
  SAFETY: [
    ROLES.OEM_SAFETY_MGR, ROLES.OEM_SAFETY_OFF,
    ROLES.GC_SAFETY_MGR, ROLES.GC_SITE_SAFETY,
    ...
    ROLES.TR_MECH_SAFETY, ROLES.TR_SAFETY,
    ROLES.RIG_SAFETY_MGR, ROLES.RIG_SAFETY_OFF,
    ROLES.BLD_SAFETY_MGR, ROLES.SEC_SAFETY, ROLES.FA_SAFETY,
    ROLES.INT_SAFETY_MGR, ROLES.CT_SAFETY, ROLES.LV_SAFETY, ROLES.MC_SAFETY, ROLES.CC_EHS,
    ROLES.SAFETY,
  ],
  QAQC: [
    ROLES.OEM_QAQC_MGR, ROLES.OEM_QAQC_INSP,
    ROLES.GC_MEP_QAQC, ROLES.GC_QAQC,
    ROLES.TR_QAQC, ROLES.BLD_QAQC,
    ROLES.SEC_QAQC, ROLES.FA_QAQC, ROLES.FA_INSPECTOR, ROLES.FA_TEST_LEAD,
    ROLES.INT_QAQC_MGR, ROLES.INT_QC_FACTORY,
    ROLES.CT_QAQC, ROLES.LV_QAQC, ROLES.LV_TESTER, ROLES.MC_QAQC,
    ROLES.RIG_INSPECTOR, ROLES.CC_CONST_QAQC, ROLES.QA_QC,
  ],
  FINANCE: [
    ROLES.OEM_FINANCE, ROLES.OEM_AR,
    ROLES.CUST_FINANCE, ROLES.CUST_PAYROLL,
    ROLES.ST_PAYROLL, ROLES.OPS_FINANCE_MGR, ROLES.OPS_PAYROLL_SPEC,
    ROLES.CC_FINANCE, ROLES.CC_PROCURE, ROLES.CC_CONTRACTS,
    ROLES.OPS_CONTRACTS_ADMIN, ROLES.CUST_PROCURE, ROLES.OPS_PROCURE_MGR,
    ROLES.FINANCE,
  ],
  OPERATIONS: [
    ROLES.OPS_OEM_DIR_PROJ, ROLES.OPS_OEM_DIR_FS, ROLES.OPS_OEM_VP_OPS, ROLES.OPS_OEM_VP_ENG,
    ROLES.OPS_GC_VP_OPS, ROLES.OPS_GC_VP_PRECON, ROLES.OPS_CXA_DIR_CX,
    ROLES.CUST_DC_OPS, ROLES.CUST_FACILITY_MGR, ROLES.CUST_CAMPUS_FAC_MGR, ROLES.CUST_CRIT_OPS_MGR,
    ROLES.CUST_NET_OPS, ROLES.INT_REMOTE_OPS, ROLES.ST_OPS_MGR,
  ],
  CONTROLS: [
    ROLES.TR_CTRL_PM, ROLES.TR_CTRL_ENG, ROLES.TR_CTRL_SUPER, ROLES.TR_CTRL_FOREMAN, ROLES.TR_CTRL_TECH, ROLES.TR_CTRL_PROG,
    ROLES.CT_PM, ROLES.CT_APM, ROLES.CT_ENG_MGR, ROLES.CT_SR_CTRL_ENG, ROLES.CT_CTRL_ENG,
    ROLES.CT_BMS_PROG, ROLES.CT_PLC_PROG, ROLES.CT_GRAPHICS, ROLES.CT_NET_ENG,
    ROLES.CT_SUPER, ROLES.CT_FOREMAN, ROLES.CT_LEAD_TECH, ROLES.CT_TECH, ROLES.CT_APP,
    ROLES.CT_STARTUP_ENG, ROLES.CT_CX_ENG,
    ROLES.INT_SR_CTRL_ENG, ROLES.INT_CTRL_ENG, ROLES.INT_PROG, ROLES.INT_SCADA_ENG,
    ROLES.AE_CTRL_ENG, ROLES.CUST_CTRL_TECH,
  ],
  CX: [
    ROLES.OEM_CX_LEAD, ROLES.OEM_SR_CX, ROLES.OEM_CX,
    ROLES.CXA_PRINCIPAL, ROLES.CXA_DIRECTOR, ROLES.CXA_LEAD, ROLES.CXA_AGENT,
    ROLES.CXA_SPEC, ROLES.CXA_FTL, ROLES.CXA_ENGINEER, ROLES.CXA_SR_ENGINEER_EE, ROLES.CXA_SR_ENGINEER_ME,
    ROLES.CXA_WRITER, ROLES.CXA_COORD, ROLES.CXA_DOC,
    ROLES.INT_CX_ENG, ROLES.CT_CX_ENG, ROLES.INT_STARTUP_ENG, ROLES.CT_STARTUP_ENG,
  ],
  PROCUREMENT: [
    ROLES.GC_BUYER, ROLES.CUST_PROCURE, ROLES.CUST_LEGAL,
    ROLES.OPS_PROCURE_MGR, ROLES.OPS_CONTRACTS_ADMIN,
    ROLES.CC_PROCURE, ROLES.CC_CONTRACTS,
    ROLES.OEM_PARTS, ROLES.OEM_RMA,
    ROLES.INT_WARRANTY, ROLES.OEM_WARRANTY, ROLES.OEM_WARRANTY_MGR,
    ROLES.ST_COMPLIANCE,
  ],
};
...
export const ROLE_LIBRARY = {
  oem: [
    ...
    },
    {
      tier: "Commissioning",
      roles: [
        { id: "oem_cx_lead", name: "Cx Lead", lens: "cx" },
        { id: "oem_sr_cx", name: "Senior Cx Engineer", lens: "cx" },
        { id: "oem_cx", name: "Cx Engineer", lens: "cx" },
      ],
    },
    {
      tier: "Engineering",
  ...
  cxa: [
    {
      ...
      roles: [
        ...
        { id: "cxa_director", name: "Cx Director", lens: "exec" },
      ],
    },
    {
      tier: "Cx Operations",
      roles: [
        { id: "cxa_lead", name: "Lead Cx Agent", lens: "cx" },
        { id: "cxa_agent", name: "Cx Agent", lens: "cx" },
        { id: "cxa_spec", name: "Cx Specialist", lens: "cx" },
        { id: "cxa_ftl", name: "Functional Test Lead", lens: "cx" },
        { id: "cxa_engineer", name: "Cx Engineer", lens: "cx" },
        {
          id: "cxa_sr_engineer_ee",
          name: "Senior Cx Engineer (EE)",
          lens: "cx",
        },
        {
          id: "cxa_sr_engineer_me",
          name: "Senior Cx Engineer (ME)",
          lens: "cx",
        },
        { id: "cxa_writer", name: "Cx Writer / Protocol Author", lens: "tech" },
        { id: "cxa_coord", name: "Cx Coordinator", lens: "pm" },
      ],
    },
    {
      tier: "Support",
  ...
  integrator: [
    ...
    },
    {
      ...
      roles: [
        ...
        { id: "int_cx_eng", name: "Integrator Cx Engineer", lens: "cx" },
      ],
    },
    {
  ...
  controls: [
    ...
    },
    {
      ...
      roles: [
        ...
        { id: "ct_cx_eng", name: "Cx Engineer", lens: "cx" },
      ],
    },
    {
      tier: "Quality",
