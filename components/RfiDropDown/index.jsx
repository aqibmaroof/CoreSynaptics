...
export function RFIDropdown({ projectId, selectedRFIs, onRFISelect }) {
  ...
  const mockRFIs = [
    { id: "rfi-1", rfi_number: "RFI-2024-001", subject: "Door Specification", priority: "High" },
    { id: "rfi-2", rfi_number: "RFI-2024-002", subject: "Window Frame Details", priority: "Normal" },
    { id: "rfi-3", rfi_number: "RFI-2024-003", subject: "HVAC Routing", priority: "Critical" },
  ];
  ...
  return (
    <div className="space-y-3">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-xs font-medium ${getPriorityColor(rfi.priority)}`}>
                            {rfi.priority}
                          </span>
                        </div>
      ...
      <p className="text-xs text-gray-400">
        Select RFIs that are related to this project. This is for organizational purposes only.
      </p>
    </div>
  );
}
