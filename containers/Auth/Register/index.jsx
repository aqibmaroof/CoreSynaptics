    ...
    >
      ...
      <section className="hidden lg:flex flex-col items-center justify-center relative w-1/2 bg-slate-900 overflow-hidden p-10">
        ...
        <div className="text-center mb-9 relative z-10">
          ...
          <div
            className="text-xs text-slate-400 mt-1 uppercase tracking-wider"
            style={{
        ...
        {/* Bottom ticker */}
        <div
          className="absolute bottom-0 left-0 right-0 h-6  flex items-center overflow-hidden"
          style={{
      ...
      {/* ══ RIGHT PANEL ══ */}
      <section
        className="flex-1 flex flex-col items-center justify-center relative p-12 overflow-y-auto"
        ...
        <div className="relative z-10 w-full max-w-xs">
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              >
                <option
                  value=""
                  disabled
                  style={{ backgroundColor: "#041520", color: "#68adcfff" }}
                >
                  Select organization type
                </option>
                <option
                  value="GC"
                  style={{ backgroundColor: "#68adcfff", color: "#ffffff" }}
                >
                  GC
                </option>
                <option
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all mt-6"
              style={{
                fontFamily: "'Rajdhani', sans-serif",
            ...
            >
              {loading ? (
                ...
                <>
                  REGISTER <span style={{ fontSize: "1.1rem" }}>→</span>
                </>
              )}
            </button>
