...
const COMPANY_TYPES = [
  ...
  },
  {
    id: "integrator",
    n: "Integrator",
    d: "Factory-built power solutions, UL assemblies",
    group: "specialist",
  },
  {
    id: "controls",
    n: "Controls / BAS",
    d: "Building automation, PLC programming",
    group: "specialist",
  },
  {
    id: "lowvoltage",
    n: "Low Voltage Cabling",
    d: "Structured cabling, fiber",
    group: "specialist",
  },
  {
    id: "mechanical",
    n: "Mechanical Contractor",
    d: "Pipefitting, HVAC, sheet metal",
    group: "specialist",
  },
  {
    id: "operations",
    n: "Operations / Corporate",
    d: "Executive, sales, back-office",
    group: "service",
  },
  {
    id: "customer_const",
    n: "Customer Construction",
    d: "Owner's construction PMs, coordinators",
    group: "core",
  },
];
