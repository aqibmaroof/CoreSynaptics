      ...
      <div className="bg-[url('/images/mainBackground.png')] bg-cover bg-center bg-no-repeat flex flex-col justify-center w-full p-8 md:p-16 lg:p-12 xl:p-20">
        ...
        <div className="mt-12">
          <div className="flex items-center gap-6 ml-2">
            ...
            <path 
            d="M2.952 19.2H6.468V10.44H9.408L9.852 7.032H6.468V4.848C6.468 3.864 6.744 3.192 8.16 3.192H9.972V0.132C9.66 0.0959999 8.592 0 7.344 0C4.728 0 2.952 1.596 2.952 4.512V7.032H0V10.44H2.952V19.2Z" fill="#00E691"/>
            </svg>

            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M9.032 20C15.0696 20 18.372 14.6132 18.372 9.94228C18.372 9.78894 18.372 9.63646 18.3624 9.48484C19.0048 8.98518 19.5592 8.36492 20 7.65506C19.4016 7.94107 18.7656 8.12887 18.1152 8.21158C18.8 7.76964 19.3128 7.07529 19.5584 6.25603C18.9136 6.66781 18.2088 6.95813 17.4736 7.11406C16.2304 5.6909 14.1512 5.62198 12.8288 6.96071C11.9768 7.82391 11.6144 9.11096 11.8792 10.3386C9.24 10.1956 6.7808 8.85337 5.1136 6.64541C4.2424 8.26068 4.688 10.3265 6.1304 11.3637C5.608 11.3473 5.0968 11.1957 4.64 10.9218V10.9666C4.6408 12.649 5.7424 14.098 7.2736 14.4314C6.7904 14.5736 6.2832 14.5942 5.792 14.4917C6.2216 15.9321 7.4544 16.9185 8.8584 16.9469C7.696 17.9307 6.26 18.4649 4.7816 18.4631C4.5208 18.4623 4.26 18.4459 4 18.4123C5.5016 19.4495 7.248 20 9.032 19.9974" fill="#00E691"/>
            </svg>

            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="0.5" y="0.5" width="43" height="43" rx="21.5" stroke="url(#paint0_radial_747_5886)"/>
            <rect x="0.5" y="0.5" width="43" height="43" rx="21.5" stroke="url(#paint1_radial_747_5886)"/>
            <rect x="0.5" y="0.5" width="43" height="43" rx="21.5" stroke="url(#paint2_radial_747_5886)"/>
            <path d="M14.983 17.1963C16.1914 17.1963 17.171 16.2167 17.171 15.0083C17.171 13.7999 16.1914 12.8203 14.983 12.8203C13.7746 12.8203 12.795 13.7999 12.795 15.0083C12.795 16.2167 13.7746 17.1963 14.983 17.1963Z" fill="#00E691"/>
            <path d="M19.237 18.8543V30.9933H23.006V24.9903C23.006 23.4063 23.304 21.8723 25.268 21.8723C27.205 21.8723 27.229 23.6833 27.229 25.0903V30.9943H31V24.3373C31 21.0673 30.296 18.5543 26.474 18.5543C24.639 18.5543 23.409 19.5613 22.906 20.5143H22.855V18.8543H19.237ZM13.095 18.8543H16.87V30.9933H13.095V18.8543Z" fill="#00E691"/>
            <defs>
            <radialGradient id="paint0_radial_747_5886" cx="0" cy="0" r="1" gradientTransform="matrix(-28.072 -30.5486 30.5486 -14.3224 22 22)" gradientUnits="userSpaceOnUse">
            <stop stop-color="white"/>
            <stop offset="1" stop-color="white" stop-opacity="0"/>
            </radialGradient>
            <radialGradient id="paint1_radial_747_5886" cx="0" cy="0" r="1" gradientTransform="matrix(26.4 22.6914 -22.6914 13.4694 22 22)" gradientUnits="userSpaceOnUse">
            <stop stop-color="#582CFF"/>
            <stop offset="1" stop-color="#582CFF" stop-opacity="0"/>
            </radialGradient>
            <radialGradient id="paint2_radial_747_5886" cx="0" cy="0" r="1" gradientTransform="matrix(-24.112 23.32 -23.32 -12.302 22 22)" gradientUnits="userSpaceOnUse">
