  ...
  return (
    <div className="p-4 sm:p-6 lg:p-5">
      <div className="mx-auto p-6 bg-[#f6f6f6] dark:bg-[#1e4742] shadow-xl rounded-lg">
        ...
        <h1 className="text-2xl font-semibold pb-1 text-[#183431] dark:text-white">
          Submit a Review
        </h1>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <h1 className="mt-3 text-xl text-[#183431] dark:text-white">Select Customer</h1>
            <select
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text mb-2 text-[#183431] dark:text-white font-medium">
            ...
            <input
              ...
              className="input input-bordered w-full bg-[#f6f6f6] dark:bg-[#1e4742] dark:border-white text-[#183431] dark:text-white placeholder-[#183431] dark:placeholder-white"
              value={huntOutfitter}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="form-control">
              <label className="label">
                <span className="label-text text-[#183431] dark:text-white mb-2 font-medium">
                  Customer Name
                </span>
              </label>
              <input
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text text-[#183431] dark:text-white font-medium">
                Rating <span className="text-error">*</span>
              </span>
            </label>
            <StarRating rating={rating} setRating={setRating} />
            <p className="text-sm mt-2 text-[#183431] dark:text-white">
          ...
          <div className="form-control">
            ...
            <textarea
              ...
              className="textarea textarea-bordered h-32 w-full  bg-[#f6f6f6] dark:bg-[#1e4742] dark:border-white text-[#183431] dark:text-white placeholder-[#183431] dark:placeholder-white"
              value={reviewContent}
