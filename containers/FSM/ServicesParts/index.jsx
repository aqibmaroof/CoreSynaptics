            ...
            <tbody>
              {tasks.map((task, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-1text-[14px]">{task.unit}</td>
                  <td className="py-4 px-1  text-[14px]">{task.unitPrice}</td>
                  <td className="py-4 px-1  text-[14px]">{task.dueDate}</td>
                  <td className="py-4 px-1  text-[14px]">{task.sku}</td>
