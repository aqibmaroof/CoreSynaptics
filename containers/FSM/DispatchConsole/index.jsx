...
const members = [
    ...
    return(
        <div className="min-h-screen flex flex-row gap-2 font-gilroy p-6 text-[#101437] dark:text-white">
            ...
            <div className="flex min-h-screen w-68 bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09]  font-gilroy p-2 mt-8 rounded-2xl card">
                <div>
                    <select
                ...
                <div className="m-auto flex flex-col items-center justify-center">
                    ...
                    <h2 className="font-semibold font-sora text-sm">No Service Appointment</h2>
                    <h3 className="font-semibold font-sora text-xs text-[#A0AEC0]">Not found under selected custom view</h3>
                </div>
            ...
            <div>
                <div className="flex mt-8 w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09] p-4 rounded-2xl card">
                    <h1 className="text-white text-2xl font-gilroy font-bold">Service Resource</h1>
                            ...
                            <div
                                ...
                                <div className="flex items-center gap-3 ">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-400 text-xs flex items-center">{member.email}
                            ...
                            <div>
                                <div className="absolute ml-5 mt-10 flex w-38  bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09]  font-gilroy p-3  rounded-3xl card">
                                    ...
                                    <div className="flex gap-2 items-center mt-1">
                                        ...
                                        <path d="M3.04053 0.759766V1.89996" stroke="#A0AEC0" stroke-width="0.74113" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M6.08105 0.759766V1.89996" stroke="#A0AEC0" stroke-width="0.74113" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M1.33008 3.45508H7.79121" stroke="#A0AEC0" stroke-width="0.74113" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M7.98133 3.23041V6.46097C7.98133 7.60117 7.41123 8.36131 6.081 8.36131H3.04047C1.71024 8.36131 1.14014 7.60117 1.14014 6.46097V3.23041C1.14014 2.09021 1.71024 1.33008 3.04047 1.33008H6.081C7.41123 1.33008 7.98133 2.09021 7.98133 3.23041Z" stroke="#A0AEC0" stroke-width="0.74113" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M5.9648 5.20663H5.96821" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M5.9648 6.34726H5.96821" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M4.55904 5.20663H4.56245" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M4.55904 6.34726H4.56245" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M3.1523 5.20663H3.15571" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M3.1523 6.34726H3.15571" stroke="#A0AEC0" stroke-width="0.74113" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
