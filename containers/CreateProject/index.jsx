    ...
    <div className="min-h-screen font-gilroy p-6 text-[#101437] dark:text-white">
        ...
        <div className="w-100  font-gilroy mt-6 mb-6 text-[#A0AEC0]">
          <div className="flex justify-between items-center">
            ...
            <input className="text-lg font-semibold" type="text" placeholder="Empty" />
          </div>
          <div className="flex items-center space-x-4 mt-3">
            <span class="text-slate-400">Progress:</span>
            <span class="text-sm ml-28">0%</span>
          ...
          <div className="flex justify-between items-center mt-3">
            ...
            <input className="text-lg font-semibold appearance-none" datepicker id="default-datepicker" type="text" class="block  ps-9 pe-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-3xl  placeholder:text-body" placeholder="Select Calender">
            </input>
            </div>
          </div>
          <div className="flex justify-between items-center mt-3">
        ...
        <div className="justify-center text-center">
            ...
            <h2 className="text-base font-sora mt-2">Let’s add your first task now</h2>
            <button onClick={()=> router.push("/CreateProject")} className="mt-5 bg-gradient-to-r from-[#3C71F0] to-[#1C3B80] text-white p-2 border-none rounded-xl transition-all">
              <div className="flex flex-row gap-2">
              <svg
                className="w-5 h-5"
                fill="none"
