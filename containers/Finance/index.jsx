      ...
      <div className="flex mt-5 w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09] p-6 rounded-2xl card">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-2">
            <h1 className="text-white text-lg md:text-2xl font-gilroy font-bold">
              Recent Activities
            </h1>
          ...
          <div className="flex items-center gap-5">
            <button className="bg-gradient-to-r from-[#3C71F0] to-[#1C3B80] text-white py-2 px-4 border-none rounded-xl transition-all cursor-pointer">
            ...
            <tbody>
              {managers.map((manager, index) => (
                ...
                >
                  ...
                  <td className="py-4 text-gray-100 text-xs">
                    {manager.invoiceNumber}
                  </td>
                  <td className="py-4 text-gray-100 text-xs">
                    {manager.orderNumber}
                  </td>
