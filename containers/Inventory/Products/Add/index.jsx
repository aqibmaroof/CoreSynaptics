...
export default function ProductAdd() {
  ...
  const handleSubmit = async (ev) => {
    ...
    try {
      ...
      setMsg({ type: "success", text: "Product created — now add SKUs to track stock" });
  ...
  return (
    <div className="min-h-screen p-6">
      <div className="mx-auto">
        ...
        <p className="text-gray-400 mb-8">Create a product master record. Add SKUs after to track individual stock variants.</p>
          ...
          <div className="bg-gray-900/50 rounded-xl border border-gray-800/50 p-6 space-y-5">
            ...
            <div>
              ...
              <textarea value={form.description} onChange={set("description")} rows={3}
                placeholder="Detailed product description, specifications..." className={`${INPUT} resize-none`} />
            </div>
