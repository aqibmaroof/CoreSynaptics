...
function AppSelect({ name, value, onChange, options, placeholder, disabled, required }) {
  return (
...
export default function RFIAdd() {
  ...
  useEffect(() => {
    ...
    getProjects(25, 1, formData.siteId, formData.projectId)
      .then((d) => setSubProjects(toArray(d))).catch(() => {});
  }, [formData.siteId]);
  ...
  const validate = () => {
    if (!formData.rfiNumber.trim()) { setError("RFI Number is required"); return false; }
    if (!formData.subject.trim())   { setError("Subject is required");    return false; }
    if (!formData.question.trim())  { setError("Question is required");   return false; }
  ...
  const inputCls = "w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500";
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" name="rfiNumber" value={formData.rfiNumber} onChange={handleChange}
              ...
              <div>
                ...
                <textarea name="question" value={formData.question} onChange={handleChange}
                  rows={4} placeholder="Detailed question requiring clarification…"
