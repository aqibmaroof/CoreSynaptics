    ...
    <div className="min-h-screen p-6">
      <div className="mx-auto">
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-4xl font-bold text-dark mb-2">Phases</h1>
        ...
        {error && (
          <div className="mb-6 bg-red-900/60 border border-red-500/30 rounded-lg p-4 flex items-start gap-3">
