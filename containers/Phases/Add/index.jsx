...
export default function PhaseAdd() {
      ...
      <div className="mx-auto">
        ...
        <form onSubmit={handleSubmit} className="bg-gray-800 rounded-xl border border-gray-700 p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-gray-500 text-xs mt-1">0-based. Must be unique within a project.</p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-500 text-xs mt-1">If no project is selected, this phase becomes a reusable org-level template (isGlobal = true).</p>
          </div>
