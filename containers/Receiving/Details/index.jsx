      ...
      <div className="flex flex-row items-center justify-between -mt-8">
        <div className="flex">
          <div className="text-[#A0AEC0] ">
            ...
            <h2 className="mt-5 text-xs md:text-sm">
              Shipping UPS Tracker Owner:
            </h2>
          </div>
          <div className="ml-4">
            <div>
              <button className="px-3 py-1.5 text-xs md:text-sm font-semibold rounded-3xl text-white bg-[#0075FF]">
                In Progress
              </button>
            </div>
          ...
          <div className="ml-4">
            ...
            <h2 className="font-semibold text-sm md:text-base flex items-center gap-4 ">
              ...
              >
                ...
                />
                <path
                  d="M15.7421 6.37239V12.7446C15.7421 14.9936 14.6176 16.493 11.9938 16.493H5.99641C3.37256 16.493 2.24805 14.9936 2.24805 12.7446V6.37239C2.24805 4.12337 3.37256 2.62402 5.99641 2.62402H11.9938C14.6176 2.62402 15.7421 4.12337 15.7421 6.37239Z"
                  stroke="#A0AEC0"
                  strokeWidth="1.46186"
                  stroke-miterlimit="10"
                  strokeLinecap="round"
        ...
        <div className="mt-8 mb-4">
          <div className="flex items-center justify-between mx-6">
            <h3 className="text-xs md:text-sm font-semibold">
              ...
              Confirm shipping bill of lading or shipping invoic
            </h3>
            <select
