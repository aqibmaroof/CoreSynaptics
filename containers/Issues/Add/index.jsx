    ...
    getProjects()
      .then((res) => {
        ...
        if (list.length) setProjects(list);
          ...
          return listV2Projects({ limit: 100 }).then((v2) =>
            setProjects(v2?.data ?? []),
          );
      })
      .catch(() =>
    ...
    <div className="min-h-screen p-6">
      <div className="mx-auto">
        ...
        <p className="text-gray-400 mb-8">
          Log a new issue against a project or asset for tracking and resolution
        </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Linking equipment makes this issue gate its phase in the
                    Project Playbook
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  <CompanySelect
                    ...
                    onChange={(id) =>
                      setForm((prev) => ({ ...prev, assignedToCompanyId: id }))
                    }
                    companies={companies}
                    onCreated={(company) =>
