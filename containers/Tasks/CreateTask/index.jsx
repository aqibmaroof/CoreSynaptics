        ...
        <div className="min-h-screen  p-6 text-[#101437] dark:text-white">
            <div className="flex items-center gap-8 justify-between mx-3">
                ...
                <div className="flex items-center justify-between gap-6">
                    ...
                    <img src="/images/mingcute_attachment-2-line.svg" alt="line-md_link" />
                    <img src="/images/mage_message-dots-round.svg" alt="line-md_link" />
                </div>
                </div>
                <div className="flex items-center gap-4">
                    <progress className="progress progress-accent w-56 ml-2" value="80" max="100"></progress>
            ...
            <div className="flex w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09]  font-gilroy p-6 mt-8 rounded-2xl card">
                <div>
                    <select className="text-2xl font-bold" name="Create Task" id="Create Task">
                ...
                <div className="w-full flex flex-row gap-4 mt-8 mx-2">
                    ...
                    <div>
                        <p>Project</p>
                        <select className="w-[470px] bg-transparent text-white placeholder-gray-500 pl-4 pr-2 py-2.5 mt-1 rounded-xl border border-white/10 focus:border-white/20 focus:outline-none transition-colors" name="Create Task" id="Create Task">
                ...
                <div className="mt-8">
                    ...
                    <div className="flex w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-2 border-white/3 border-t p-6 mt-2 rounded-2xl card">
                        ...
                        <div>
                            ...
                            <p className="mt-4">Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien.</p>
                ...
                <div className="flex flex-row gap-4 w-full items-center justify-between mt-4">
                    <div>
                        ...
                        <input 
                            ...
                            type="text" 
                            className="block w-xs pl-4 pr-2 py-2.5 mt-1 rounded-xl border border-white/10 text-md px-3 focus:border-white/20 focus:outline-none placeholder:text-body" 
                    ...
                    <div className="">
                        <p>Tasks Status:</p>
                        <select className="w-xs bg-transparent text-white placeholder-gray-500 pl-4 pr-2 py-2.5 mt-1 rounded-xl border border-white/10 focus:border-white/20 focus:outline-none transition-colors" name="Create Task" id="Create Task">
                    ...
                    <div>
                        <p>Priority:</p>
                        <select className="w-2xs bg-transparent text-white placeholder-gray-500 pl-4 pr-2 py-2.5 mt-1 rounded-xl border border-white/10 focus:border-white/20 focus:outline-none transition-colors" name="Create Task" id="Create Task">
            ...
            <div className="flex w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09]  font-gilroy p-6 mt-8 rounded-2xl card">
                <div className="flex items-center gap-4">
                    ...
                    <h3 className="border-b border-[#00E691] text-white text-lg font-medium">Sub Task</h3>
