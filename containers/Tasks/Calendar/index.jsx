        ...
        <div className="min-h-screen  p-6 text-[#101437] dark:text-white">
            ...
            <div className="flex w-full bg-gradient-to-r from-gray-600/10 to-gray-500/10 border-3 border-white/[0.03] border-t-white/[0.09]  font-gilroy p-6 mt-8 rounded-3xl card">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <h1 className="text-white mt-5 ml-4 text-2xl font-bold mr-2">
                        Task Views
                    </h1>
                    ...
                    <button onClick={() => router.push("/Tasks/Kanban")} className="btn mt-5 bg-transparent  text-white p-2 border-2 border-white/[0.03] border-t-white/[0.09] rounded-3xl transition-all">
                    ...
                    <div>
                        ...
                        <div className="flex flex-row gap-4 w-full mt-4">
                            <div>
                                ...
                                <summary className="btn m-1 w-full bg-transparent text-white placeholder-gray-500 pl-4 pr-2 py-2.5 mt-1 rounded-xl border border-white/10 focus:border-white/20 focus:outline-none transition-colors">open or close</summary>
                        ...
                        <div className="flex items-center gap-2 mt-4">
                            ...
                            <div>
                            <button className="btn btn-medium bg-[#454A62] rounded-2xl h-8 font-semibold text-white border border-[#656A80] hover:bg-slate-700">+ Invite</button>
                            </div>
                        </div>
                        <div className="mt-4">
                            <p>Attach Files</p>
                            <div className="flex items-center justify-center w-full mt-1">
                                <label for="dropzone-file" class="w-full bg-transparent text-white placeholder-gray-500 pl-4 pr-2 rounded-xl border border-white/10 focus:border-white/20 focus:outline-none transition-colors cursor-pointer hover:bg-neutral-tertiary-medium">
                                    <div class="flex flex-col items-center justify-center text-body pt-5 pb-6">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M11.1041 20.9724V13.5703L8.63672 16.0377" stroke="#0075FF" stroke-width="1.85053" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M11.1016 13.5703L13.5689 16.0377" stroke="#0075FF" stroke-width="1.85053" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M27.1425 12.3373V18.5057C27.1425 24.6741 24.6751 27.1415 18.5067 27.1415H11.1046C4.93612 27.1415 2.46875 24.6741 2.46875 18.5057V11.1036C2.46875 4.93515 4.93612 2.46777 11.1046 2.46777H17.273" stroke="#0075FF" stroke-width="1.85053" stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M27.1429 12.3373H22.2082C18.5071 12.3373 17.2734 11.1036 17.2734 7.40252V2.46777L27.1429 12.3373Z" stroke="#0075FF" stroke-width="1.85053" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <p class="mb-2 text-sm">Drag here or upload from directory</p>
                                    </div>
