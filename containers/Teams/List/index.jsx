          ...
          <table className="w-full">
            <thead className="bg-[#080C26] rounded-2xl">
              <tr className="rounded-2xl">
                ...
                <th className="py-4 px-4 text-gray-400 font-medium text-sm">Team Name</th>
                <th className="py-4 px-4 text-gray-400 font-medium text-sm">Members</th>
                <th className="py-4 px-4 text-gray-400 font-medium text-sm">Status</th>
                <th className="py-4 px-4 text-gray-400 font-medium text-sm">Actions</th>
              </tr>
            </thead>
            <tbody>
              {filtered?.length === 0 ? (
                  ...
                  >
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center justify-center gap-3">
                        <div className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-br from-orange-400 to-pink-500 text-white font-bold text-sm">
                    ...
                    <td className="py-4 px-4">
                      <button
                        onClick={() => router.push(`/Teams/Members/${team.id}`)}
                        className="flex items-center justify-center gap-2 mx-auto text-blue-400 hover:text-blue-300 transition-colors"
                      >
                       <FaPlus/> <FaUsers />
